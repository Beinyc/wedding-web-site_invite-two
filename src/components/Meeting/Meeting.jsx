    ...
    return (
        <div className='meeting'>
            <div className='meeting__permissions'>
                ...
                <p className='meeting__paragraph-up'>Просим вас подтвердить свое присутствие не позднее 28 августа 2024 года </p>
                ...
                <br />
                Никита <span className='meeting__span'>8-999-999-88-88</span>
                </p>
            </div>
        </div>
    );
